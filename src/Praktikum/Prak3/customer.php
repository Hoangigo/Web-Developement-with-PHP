    ...
    protected function generateView(): void
    {
        ...
        */
        ...
        <section>
            ...
            <p>Bestellt  <input type="radio" id="ordered"          disabled   name = " $row[ordered_article_id]"   value="Bestellt"  $status[0]> </p>
            <p>Im Ofen   <input type="radio" id="in_progress"      disabled   name = " $row[ordered_article_id]"   value="Im Ofen"   $status[1]> </p>
            <p>Fertig    <input type="radio" id="ready_to_deliver" disabled   name = " $row[ordered_article_id]"   value="Fertig"    $status[2]> </p>
            <p>Unterwegs <input type="radio" id="on_road"          disabled   name = " $row[ordered_article_id]"   value="Unterwegs" $status[3]> </p>
            <p>Geliefert <input type="radio" id="delivered"        disabled   name = " $row[ordered_article_id]"   value="Geliefert" $status[4]> </p>
            </section> 
        HTML;
            }
        } else {

        ...
        foreach ($data as $row) {
            ...
            if ($status[3] == "" && $status[4] == "") {
                ...
                <section>
                    ...
                    <p>Bestellt  <input type="radio" name = "$row[ordered_article_id]"  value="{$row['ordered_article_id']}|0" $status[0] > </p>
                    <p>Im Ofen  <input type="radio" name = "$row[ordered_article_id]"  value="{$row['ordered_article_id']}|1"  $status[1]> </p>
                    <p>Fertig  <input type="radio" name = "$row[ordered_article_id]"  value="{$row['ordered_article_id']}|2"  $status[2]> </p>
                    </section>    
                HTML;
